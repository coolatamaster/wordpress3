...
function goldeneagle_optionsframework_options_page() {
    ...
    <div class="trail-notify">
        <h1><?php _e('Get Golden Eagle Responsive Theme PRO!', 'golden_eagle'); ?></h1>
        <p><?php _e('You are Using the FREE Version of golden eagle Theme. Upgrade to Pro Version for extra features, Contact Page Template, Gallery Page, Multiple Color Skins, Full Featured Slider, Premium Support and much more.', 'golden_eagle'); ?> </p>
        <a href="<?php echo esc_url(INKTHEME_GOLDEN_EAGLE_LINK); ?>" target="blank"><?php _e('Upgrade to Golden Eagle Theme PRO &rarr;', 'golden_eagle'); ?></a>

    </div>
    <div class="wrap" id="of_container">
        <div id="of-popup-save" class="of-save-popup">
            <div class="of-save-save"><?php _e('Options Updated', 'golden_eagle'); ?></div>
        </div>
        <div id="of-popup-reset" class="of-save-popup">
            <div class="of-save-reset"><?php _e('Options Reset', 'golden_eagle'); ?></div>
        </div>
